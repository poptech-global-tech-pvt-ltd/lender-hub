...
// profileExecutor implements HttpExecutor for Profile operations
...
// NewProfileExecutor creates a new profile HTTP executor
func NewProfileExecutor() HttpExecutor {
	...
	breaker := circuitbreaker.New(circuitbreaker.DefaultProfileConfig())
	retryCfg := retry.Config{
		MaxAttempts:  3,
...
func (e *profileExecutor) Do(ctx context.Context, req Request) (*Response, error) {
...
func (e *profileExecutor) CircuitState() string {
